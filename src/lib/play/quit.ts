 ...
 * exits to DOS. Here the character is written back into the roster and the maps into the blob
 * beside it, and the session ends. The floor's monsters are not kept, which
 * `src/lib/play/README.md` says why.
 */
