...
|---|---|---|
| 0x07b4, 0x07b5 | `DAT_6000_c8a6/c8a7` | two bytes the map display uses as a cursor, set to half the section's width and height (40, 55); `movecontrol` recomputes them the same way whenever play starts |
