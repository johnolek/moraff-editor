...
| hints (`UH.BIN`) and spell help (`USPELLS.HLP`) | `give_hint` 2000:313a, `read_spell_help` 2000:7a78 | readers identified; the `.uhp` files in the game folder are the plain-text sources |
...
7. **Polish**: hints from the `.uhp` texts, the monster manual (`monster_manual`
